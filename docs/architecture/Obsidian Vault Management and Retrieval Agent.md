...
The system should be built inside the vault itself, using a 00 System folder. Human-editable schema and templates should live in Markdown. Machine-readable state, manifests, and indexes should live in JSON/YAML/Markdown files inside the agent folder.
...
11. Prioritize notes in 01 Inbox.
...
text 00 System/0.01 agent/config.yaml 00 System/0.01 agent/schema.json 00 System/0.02 templates/0.020 vault schema.md 00 System/0.02 templates/0.021 property values.md 00 System/0.02 templates/0.022 folder norms.md 00 System/0.01 agent/retrieval/00 retrieval-readme.md 
...
text 00 System/0.01 agent/ 00 System/0.99 trash/ .git/ .obsidian/ 

The scan should include normal note templates in 00 System/0.02 templates/ as system/template files, but these should not be processed as ordinary notes.
...
text 00 System/0.01 agent/review/needs-review.md 00 System/0.01 agent/review/processing-errors.md 
...
1. Unprocessed notes in 01 Inbox
2. Stale notes in 01 Inbox
...
Repeatedly process notes in 01 Inbox, one at a time.
...
8. Process files in 00 System/0.01 agent/ as normal notes.
9. Process files in 00 System/0.99 trash/ as normal notes.
...
text 00 System/0.02 templates/note-types/ 
...
text 00 System/0.01 agent/retrieval/00 retrieval-readme.md 00 System/0.01 agent/retrieval/01 vault-map.md 00 System/0.01 agent/retrieval/02 note-catalog.md 00 System/0.01 agent/retrieval/03 property-index.md 00 System/0.01 agent/retrieval/04 summary-brief.md 00 System/0.01 agent/retrieval/summaries-standard/by-type/ 00 System/0.01 agent/retrieval/summaries-standard/by-domain/ 00 System/0.01 agent/retrieval/summaries-standard/by-project/ 00 System/0.01 agent/retrieval/summaries-standard/by-status/ 00 System/0.01 agent/retrieval/deep-summaries/ 00 System/0.01 agent/retrieval/indexes/by-type/ 00 System/0.01 agent/retrieval/indexes/by-domain/ 00 System/0.01 agent/retrieval/indexes/by-project/ 00 System/0.01 agent/retrieval/indexes/by-status/ 
...
text 00 System/0.01 agent/review/proposed-values.md 
...
text 00 System/0.01 agent/review/needs-review.md 
...
text 00 System/0.01 agent/logs/YYYY-MM-DD.md 
...
text 00 System/0.01 agent/backups/ 
...
If enabled, only move notes out of 01 Inbox when:
...
Never move notes from outside 01 Inbox automatically unless explicitly configured.

## Folder norms

Maintain human-readable folder norms in:

text 00 System/0.02 templates/0.022 folder norms.md 
...

{
  ...
  "note_type": {
    ...
    "template_path": "00 System/0.02 templates/note-types/argument.md"
  },
  "template": {
    "frontmatter": {
      "id": null,
  ...
  "files_to_update": [
    ...
    "00 System/0.02 templates/0.020 vault schema.md",
    "00 System/0.02 templates/0.022 folder norms.md",
    "00 System/0.02 templates/note-types/argument.md"
  ],
  "requires_retrieval_rebuild": true,
...
Template: 00 System/0.02 templates/note-types/argument.md
